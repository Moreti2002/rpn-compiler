# analisador semântico - validação de estruturas de controle (IF, WHILE)
...
def analisar_semantica_controle(arvore_sintatica, tabela_simbolos):
    ...
    try:
        # percorrer árvore validando estruturas de controle
...
def validar_estruturas_controle(no, tabela_simbolos, erros):
    """
    percorre árvore validando estruturas de controle
...
def validar_estrutura_decisao(no, tabela_simbolos):
    ...
    # validar que blocos são expressões válidas
    ...
    if tipo_v and tipo_f and tipo_v != tipo_f and tipo_v != 'erro' and tipo_f != 'erro':
        # aviso: blocos com tipos diferentes (não é erro fatal)
        return {
            'tipo': 'AVISO_CONTROLE',
...
def validar_estrutura_laco(no, tabela_simbolos):
    ...
    # validar que bloco é expressão válida
...
def validar_condicao(condicao_no, tabela_simbolos):
    ...
    # condição deve ter tipo booleano
...
def gerar_relatorio_controle(erros, avisos=None):
    """
    gera relatório de análise de estruturas de controle
    ...
    """
    relatorio = "# Relatório de Análise de Estruturas de Controle\n\n"
    ...
    relatorio += f"- Erros críticos: {len(erros_criticos)}\n"
...
if __name__ == '__main__':
    ...
    try:
        ...
        testes = [
            ("((5 10 >) ((5)) ((10)) IF)", "IF com condição válida"),
            ("((5 10 <) ((5 1 +) CONTADOR) WHILE)", "WHILE com condição válida")
        ]
