...
programa_principal:
    ...
    ; t2 = t0 % t1
mod_loop_0:
    cp r18, r17  ; comparar resto com divisor
    brlo mod_done_0  ; se resto < divisor, terminou
    sub r18, r17  ; resto -= divisor
    rjmp mod_loop_0
mod_done_0:
    ; r18 contem o resto
    ...
    ; t5 = t3 % t4
mod_loop_1:
    cp r21, r20  ; comparar resto com divisor
    brlo mod_done_1  ; se resto < divisor, terminou
    sub r21, r20  ; resto -= divisor
    rjmp mod_loop_1
mod_done_1:
    ; r21 contem o resto
    ...
    ; t8 = t6 % t7
mod_loop_2:
    cp r24, r23  ; comparar resto com divisor
    brlo mod_done_2  ; se resto < divisor, terminou
    sub r24, r23  ; resto -= divisor
    rjmp mod_loop_2
mod_done_2:
    ; r24 contem o resto
    ...
    ; t11 = t9 % t10
mod_loop_3:
    cp r27, r26  ; comparar resto com divisor
    brlo mod_done_3  ; se resto < divisor, terminou
    sub r27, r26  ; resto -= divisor
    rjmp mod_loop_3
mod_done_3:
    ; r27 contem o resto
