...
programa_principal:
    ...
    brlo cmp_end_0  ; se op1 < op2, resultado = 0
    breq cmp_end_0  ; se op1 == op2, resultado = 0
    ldi r18, 1  ; senão op1 > op2, resultado = 1
    rjmp cmp_true_0
cmp_end_0:
    ldi r18, 0
cmp_true_0:
    ; DEBUG: Imprimir t2 = t0 > t1
    mov r16, r18
    call print_number
    call print_space
    ...
    cp r21, r20  ; comparar t3 < t4
    brlo cmp_true_1  ; se menor (unsigned), resultado = 1
    ldi r21, 0  ; senão, resultado = 0
    rjmp cmp_end_1
cmp_true_1:
    ldi r21, 1
cmp_end_1:
    ; DEBUG: Imprimir t5 = t3 < t4
    mov r16, r21
    call print_number
    call print_space
    ; Salvar Y na SRAM (0x0138)
    sts 0x0138, r21
    ldi r22, 5  ; t6 = 5
    ldi r23, 5  ; t7 = 5
    mov r24, r22  ; copiar operando1
    cp r24, r23  ; comparar t6 == t7
    breq cmp_true_2  ; se igual, resultado = 1
    ldi r24, 0  ; senão, resultado = 0
    rjmp cmp_end_2
cmp_true_2:
    ldi r24, 1
cmp_end_2:
    ; DEBUG: Imprimir t8 = t6 == t7
    mov r16, r24
    call print_number
    call print_space
    ; Salvar Z na SRAM (0x0139)
    sts 0x0139, r24
