...
programa_principal:
    ...
    lds r21, 0x0137
    ; Carregar Y da SRAM (0x0138)
    lds r22, 0x0138
    mov r23, r21  ; copiar operando1
    sub r23, r22  ; t5 = X - Y
    ; DEBUG: Imprimir t5 = X - Y
    mov r16, r23
    call print_number
    call print_space
    ldi r22, 5  ; t6 = 5
    ...
    lds r25, 0x0123
    mov r26, r24  ; copiar operando1
    mul r26, r25  ; t8 = C * D
    mov r26, r0  ; resultado em r0 (8-bit)
    ; DEBUG: Imprimir t8 = C * D
    mov r16, r26
    call print_number
    call print_space
